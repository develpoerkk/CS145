...
urls = ('/currtime', 'curr_time',
		...
		'/search', 'search',
		'/add_bid', 'add_bid',
		'/index/(.*)', 'index',  # may be used to show details of an auction
...
class index:
    def GET(self, name):
        ...
        status = sqlitedb.statusOfId(i.name)
        details = sqlitedb.detailsOfId(i.name)
        bids = sqlitedb.biddersOfId(i.name)
        categories = sqlitedb.categoriesOfId(i.name)
        seller = sqlitedb.sellerOfId(i.name)
        return render_template('index.html', search_result = details, auction_status = status, search_bids = bids, auction_categories = categories, auction_seller = seller)
